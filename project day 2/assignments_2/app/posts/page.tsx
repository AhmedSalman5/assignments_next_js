...
const postList =  sortdPosts.map((post:Posts) =>
    <Link  style={{width:"70%",backgroundColor:'white' , color:"black" , marginTop:"20px",          padding:"16px" ,  borderRadius:"5px"}} href={`posts/${post.id}`}> 
        <div key={post.id}> 
  ...
  return (
    <> 
         <div style={{justifyContent:"center",alignItems:"center",display:"flex", flexDirection:"column"}}> 
                ...
                <Link href="/posts?orderBy=title">sort by title</Link>
                <Link href="/posts?orderBy=body">sort by body</Link>
            {postList}
         </div>
    </> 
